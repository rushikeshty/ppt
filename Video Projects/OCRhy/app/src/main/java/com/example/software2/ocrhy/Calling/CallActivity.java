package com.example.software2.ocrhy.Calling;
...
import com.example.software2.ocrhy.HomeActivity;
import com.example.software2.ocrhy.R;
...
public class CallActivity extends AppCompatActivity implements RecognitionListener{
    ...
    public void onError(int i) {
        Toast.makeText(getApplicationContext(), "check microphone permissions", Toast.LENGTH_SHORT).show();
